...
import 'package:nehru_science_center_client/Screen/BookingPage/adult_item_counter.dart';
import 'package:nehru_science_center_client/Screen/BookingPage/children_item_counter.dart';
...
class _BookingPageState extends State<BookingPage> {
  ...
  _bookTicket() {
    ...
    ticketRef.add({
      ...
      'price': (100 * countState.adult_count.toInt()) +
          ((100) / 2 * countState.child_count.toInt()),
    }).then((value) {
                    ...
                    (() => RichText(
                          ...
                          TextSpan(
                            text: countState.adult_count == 0 &&
                                    countState.child_count == 0
                                ? "0"
                                : ((100 * countState.adult_count.toInt()) +
                                        ((100) /
                                            2 *
